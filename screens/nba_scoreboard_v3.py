#!/usr/bin/env python3
"""Stacked-logo layout (v3) for the NBA Scoreboard."""

from __future__ import annotations

from utils import ScreenImage, log_call

from screens import nba_scoreboard_v2 as base
...
@log_call
def draw_nba_scoreboard_v3(display, transition: bool = False) -> ScreenImage:
