...
Dual-game layout version of NHL Scoreboard - shows 2 games per row.
...
LEAGUE_LOGO_GAP         = 10
LEAGUE_LOGO_SCALE       = 0.65
LEAGUE_LOGO_HEIGHT      = max(1, int(round(LOGO_HEIGHT * LEAGUE_LOGO_SCALE)))
...
def _compose_canvas(games: list[dict]) -> Image.Image:
    ...
    for idx, game in enumerate(games):
        ...
        # Draw vertical separator between columns (except for last game if odd number)
