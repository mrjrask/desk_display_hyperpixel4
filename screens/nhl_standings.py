...
DIVISION_FONT = clone_font(FONT_TITLE_SPORTS, 34)
COLUMN_FONT = clone_font(FONT_STATUS, 30)
_COLUMN_POINTS_SIZE = max(8, getattr(COLUMN_FONT, "size", 30) - 4)
COLUMN_FONT_POINTS = clone_font(COLUMN_FONT, _COLUMN_POINTS_SIZE)
ROW_FONT = clone_font(FONT_STATUS, 36)
_TEAM_NAME_FONT_SIZE = max(8, getattr(ROW_FONT, "size", 36) - 4)
